...
ACCESS_ACTIVATED_TEXT = "Доступ к боту активирован."
ACCESS_REVOKED_TEXT = (
    "Доступ к боту приостановлен. Свяжитесь с администратором для активации."
)
ACCESS_EXPIRED_TEXT = (
    "Срок действия доступа к боту истёк. Свяжитесь с администратором для продления."
)
